...
function findAdv() {
	...
	var nome = document.getElementById("advogados").value;
	var result = document.getElementById("resultadoAdvogadosCadastrados");
	var xmlreq = CriaRequest();
	// Exibi a imagem de progresso
	result.innerHTML = '<img src="img/ajax_load/ajax-loader.gif"/>';
	// Iniciar uma requisição
	xmlreq.open("GET", "js/ajax_load/adv/request_advogados.php?advogados=" + nome, true);
